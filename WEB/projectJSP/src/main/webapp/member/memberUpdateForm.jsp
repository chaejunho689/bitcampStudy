...
<%
	...
	if (memberDTO == null) {
	    out.println("<script>alert('회원 정보를 불러올 수 없습니다. 다시 로그인해 주세요.'); location.href='../login.jsp';</script>");
	    return;
	}
...
<img src="../image/ompangi.gif" width="100" height="100" alt="홈" onclick="location.href='../index.jsp'" style="cursor: pointer;">
	...
	<form method="post" action="./memberUpdate.jsp" onsubmit="return updateSubmitCheck(this)">
	    <table>
	        <tr>
	            <th>이름</th>
	        ...
	        <tr>
	            <th>아이디</th>
	            <td><input type="text" id="id" name="id" onchange="idcheckYn_change()" value="<%=memberDTO.getId() %>" readonly>
	            	<div id="idDiv">
	            	</div>
	            </td>
	        </tr>
